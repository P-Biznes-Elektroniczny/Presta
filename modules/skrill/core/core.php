    ...
    public static $paymentMethods = array (
        ...
        'PSC' => array(
            ...
            'allowedCountries' => array(
                ...
                'LUX','MLT','MEX','NLD','MNP','NOR','POL','PRT','PRI','PRY','ROU','SVK','SVN','ESP','SWE','CHE','TUR',
                'GBR','USA','VIR'
            )
        ),
        'PCH' => array(
            'name' => 'Paysafecash',
            'allowedCountries' => array(
                'AUT','BEL','CAN','CHE','CYP','CZE','DNK','FRA','GRC','HRV','HUN','IRL','ITA','LTU','LUX','MLT','NLD',
                'POL','PRT','ROU','SVK','SVN','SWE','ESP', 'GBR'
            )
        ),
        'ACC' => array(
